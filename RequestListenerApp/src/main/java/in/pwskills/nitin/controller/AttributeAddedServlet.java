...
public class AttributeAddedServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		System.out.println("Intialization -> AttributeAddedServlet.init()");
	}
	...
	//Adding the attribute to request object
	...
	out.println("<h1 style='color:red; text-align:centre;'>PERFORMING OPERATIONS ON SERVLETREQUEST OBJECT(ATTRIBUTEDATA)</h1>");	
	}
	...
	@Override
	public void destroy() {
		System.out.println("SeInstantiation -> AttributeAddedServlet.destroy()");
	}
