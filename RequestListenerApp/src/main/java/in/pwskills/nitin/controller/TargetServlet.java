...
public class TargetServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1 style='color:red; text-align:centre;'>REQUEST COMING FRON TARGETSERVLET...</h1>");
		out.println("<h1 style='color:red; text-align:centre;'>The no of hits for the webapplication is :: "+RequestDemoListener.count+"</h1>");
